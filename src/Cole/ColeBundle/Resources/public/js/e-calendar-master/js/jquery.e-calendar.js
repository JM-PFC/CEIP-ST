...
(function ($) {
    ...
    var eCalendar = function (options, object) {
        ...
        function print() {
            ...
            var dLastDayOfPreviousMonth = new Date(dYear, dMonth, 0).getDate() - dWeekDayOfMonthStart + 1; //Modified dMonth+1 -> dMonth
            ...
            //Comprobaciones de existencia de eventos.
            if($("#calendar .c-event-grid .c-event-list>div[class!='div-over']").length){
                $("#calendar .c-event-grid .c-event-list>div[class!='div-over']").each(function(){  
                    $(this).addClass("oculto");
                });

                $("#calendar .c-event-grid .c-event-list .c-event-item .title").each(function(){  
