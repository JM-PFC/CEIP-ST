...
class PadresType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('estadoCivil','choice',array('label' => 'Estado Civil', 'choices' => array('Casado/a' => 'Casado/a', 'Soltero/a'=>'Soltero/a', 'Separado/a'=>'Separado/a', 'Divorciado/a'=>'Divorciado/a','Pareja de hecho'=>'Pareja de hecho','Viudo/a'=>'Viudo/a'),'empty_data' => null,'empty_value'=> 'Seleccione estado','required'=> true,'multiple'=>false))
