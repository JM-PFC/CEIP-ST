    ...
    */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('perfilAcademico', 'textarea',array('label' => 'Observaciones:', 'max_length' => 1200,'required' => false, 'attr' => array('type'=>'textarea', 'validation' => 'Words')))
            ->add('perfilProfesional', 'textarea',array('label' => 'Observaciones:', 'max_length' => 1200,'required' => false, 'attr' => array('type'=>'textarea', 'validation' => 'Words')))
            ->add('nivel', 'choice', array('label' => 'Profesor de:','choices' => array('Infantil' => 'Infantil', 'Primaria'=>'Primaria'), 'empty_data' => null,'empty_value'=> 'Seleccione nivel','required'=> true, 'multiple'=>false, 'attr' => array('validation' => 'Empty')))
            ...
            ->add('observaciones', 'textarea',array('label' => 'Observaciones:','required' => false, 'max_length' => 500, 'attr' => array('type'=>'textarea')))
