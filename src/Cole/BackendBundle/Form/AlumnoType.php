...
class AlumnoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('direccion','text',array('label' => 'Dirección','max_length' => 50, 'attr' => array('validation' => 'Empty')))
            ...
            ->add('cursoIngreso','entity',array('class' => 'BackendBundle:Curso', 'empty_value'=> 'Elige un curso','required'=> true, 'attr' => array('validation' => 'Empty')))

            //->add('curso')
            //->add('grupo')
            ->add('foto', 'file', array('required' => false, 'attr' => array( 'class' => 'archivo')))
            //->add('numAlum')
            ->add('grupoSangre','choice',array('empty_value'=> 'Elige una opción','label' => 'Grupo Sanguíneo', 'choices' => array('A+' => 'A+', 'A-'=>'A-', 'B+'=>'B+', 'B-'=>'B-','AB+'=>'AB+','AB-'=>'AB-','0+'=>'0+','0-'=>'0-'),'required'=> false,'multiple'=>false))

            ->add('observaciones', 'textarea',array('label' => 'Observaciones:', 'attr' => array('type'=>'textarea', 'validation' => 'Words')))
            //->add('activo')
            //->add('responsable1')
            //->add('responsable2')
