...
class AlumnoType extends AbstractType
{
    ...
    {
        $builder
            ->add('nombre','text',array('label' => 'Nombre', 'max_length' => 50,'attr' => array('validation' => 'Empty, Words')))
            ->add('apellido1','text',array('label' => 'Primer Apellido', 'max_length' => 50,'attr' => array('validation' => 'Empty, Words')))
            ->add('apellido2','text',array('label' => 'Segundo Apellido','max_length' => 50, 'attr' => array('validation' => 'Empty, Words')))
            ...
            ->add('direccion','text',array('label' => 'Dirección','max_length' => 100, 'attr' => array('validation' => 'Empty, LetterInitial')))
            ->add('localidad','text',array('label' => 'Localidad','max_length' => 100, 'attr' => array('validation' => 'Empty, Letters')))
            ->add('provincia','text',array('label' => 'Provincia','max_length' => 50,'attr' => array('validation' => 'Empty, Letters')))
