...
$upload_dir = '/Symfony/web/uploads/noticias/contenido/'; // path from base_url to upload base dir
$current_path = '../../../../../../../../../../../web/uploads/noticias/contenido/'; // relative path from filemanager folder to upload files folder
